<?php
if ( ! class_exists( 'World_News_Posts_List_Widget' ) ) {
	/**
	 * Adds World_News_Posts_List_Widget Widget.
	 */
	class World_News_Posts_List_Widget extends WP_Widget {
		...
		public function __construct() {
			...
			parent::__construct(
				'world_news_magazine_list_widget',
				__( 'Ascendoor Posts List Widget', 'world-news' ),
