<?php
if ( ! class_exists( 'World_News_Posts_Tile_Widget' ) ) {
	/**
	 * Adds World_News_Posts_Tile_Widget Widget.
	 */
	class World_News_Posts_Tile_Widget extends WP_Widget {

		/**
		 * Register widget with WordPress.
		 */
		public function __construct() {
			$world_news_tile_widget_ops = array(
				'classname'   => 'ascendoor-widget magazine-tile-section style-1',
				'description' => __( 'Retrive Posts Tile Widgets', 'world-news' ),
			);
			parent::__construct(
				'world_news_magazine_tile_widget',
				__( 'Ascendoor Posts Tile Widget', 'world-news' ),
				$world_news_tile_widget_ops
			);
		}
